...
@pytest.mark.parametrize("type, category, components", [("pca", "", "1, 2, 3"), ("pca", "", "1"), ("pca", "", "4"), ("pca", "", "1, 3, 2"), ("pca", "", "1, 4"), ("umap", "", "1, 2"), ("umap", "", "1"), ("umap", "", "2"), ("umap", "pc3", "1, 2"), ("umap", "pcn", "1, 2")])
...
@pytest.mark.parametrize("type, category, components", [("wrong_type", "", "1, 2, 3"), ("pca", "wrong_category", "1, 2, 3"), ("pca", "", "1, 2, 3, 4, 5"), ("pca", "", "1, 15"), ("pca", "", "45"), ("umap", "", "3"), ("umap", "pon", "1, 2"),])
...
@pytest.mark.parametrize("test_case, type, category, components", [(1, "pca", "", "1, 2, 3"), (2, "pca", "", "1"), (3, "pca", "", "4"), (4, "pca", "", "1, 3, 2"), (5, "pca", "", "1, 4"), (6, "umap", "", "1, 2"), (7, "umap", "", "1"), (8, "umap", "", "2"), (9, "umap", "pc3", "1, 2"), (10, "pca", "pcn", "3,1"), (11, "umap", "pcn", "1, 2")])
